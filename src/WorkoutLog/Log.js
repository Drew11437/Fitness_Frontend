  ...
  const UICrtl = (function () {
    ...
    return {
      populateItemList: function (items) {
        let html = "";
        items.forEach((item) => {
          html += `<li className="collection-item" id="item-${item.id}">
                <strong>${item.name}</strong> - <em>${item.calories} calories</em>
                <a href=3"" className="secondary-content"><i className="edit-item fa fa-pencil"></i></a>
            </li>`;
        });
      ...
      addListItem(item) {
        ...
        li.innerHTML = `
        <strong>${item.name}</strong> - <em>${item.calories} calories</em>
        <a href=3"" className="secondary-content">
        <i className="edit-item fa fa-pencil"></i></a>`;
        document
...
<nav>
    <div className="nav-wrapper blue">
        <div className="container">
            <a href="#" className="brand-logo center">Tack calories</a>
            <ul>
                <li>
                    <a href="#" className="clear-btn btn blue lighten-3">Clear All</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div className="card">
        <div className="card-content">
            ...
            <form className="col">
                ...
                <div className="row">
                    <button className="btn add-btn blue darken-3"><i className="fa fa-plus"></i> Add Meal</button>
                    <button className="btn update-btn orange"><i className="fa fa-pencil-square-o"></i> Update Meal</button>
                    <button className="btn delete-btn red"><i className="fa fa-remove"></i> Delete Meal</button>
                    <button className="btn back-btn grey pull-right"><i className="fa fa-chevron-circle-left"></i>
                        Back</button>
                </div>
            </form>
        </div>
    ...
    {/* <!-- Calories count -->
    <h3 className="center-align">Total calories: <span className="total-calories">0</span></h3>

    <!-- Item list -->
    <ul id="item-list" className="collection">
        <!-- <li className="collection-item" id="item-0"><strong>Steak:</strong> <em>900 Calories</em>
            <a href=3"" className="secondary-content"><i className="fa fa-pencil"></i></a>
        </li>
        <li className="collection-item" id="item-0"><strong>Egg:</strong> <em>600 Calories</em>
            <a href=3"" className="secondary-content"/><i className="fa fa-pencil"></i></a>
        </li>
        <li className="collection-item" id="item-0"><strong>Cookies:</strong> <em>900 Calories</em>
            <a href=3"" className="secondary-content"><i className="fa fa-pencil"></i></a>
        </li> -->
    </ul> */}
